      ...
      <div className="w-full max-w-[600px] bg-[#121212] border border-zinc-800 rounded-[12px] shadow-2xl flex flex-col relative overflow-hidden">
        <div className="flex items-center justify-between p-5 border-b border-zinc-800/60 shrink-0 bg-[#1A1A1A]">
          <div className="flex items-center gap-2.5">
            ...
            <h3 className="text-white font-bold text-[15px] tracking-wide font-sans">Import System Specification</h3>
          </div>
        ...
        <div className="p-6 flex flex-col gap-4">
          <p className="text-[12px] text-zinc-400 leading-relaxed font-sans tracking-tight">
        ...
        <div className="p-5 border-t border-zinc-800/60 bg-[#1A1A1A] flex justify-end gap-3 shrink-0">
          <button onClick={onClose} className="px-5 py-2.5 rounded-[8px] text-[12px] font-bold text-[#a6a6a6] hover:text-white hover:bg-zinc-800 transition-colors font-sans">
            Cancel
          </button>
          <button onClick={onImport} disabled={!importInputValue.trim()} className="px-6 py-2.5 rounded-[8px] text-[12px] font-bold bg-emerald-600 hover:bg-emerald-500 text-white transition-all shadow-md disabled:opacity-50 flex items-center gap-2 font-sans">
