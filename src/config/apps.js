...
export const APP_REGISTRY = [
  ...
  { id: "nexus-preview",       label: "NEXUS Preview",      sub: "NEXUS Preview",       abbr: "Np", icon: "▤", desc: "생성된 타이틀을 실제 플랫폼 목업 위에 자동 배치·검수·출력",   group: "production", color: "#22B8CF", canReceive: ["typecore-sovereign","typecore-breeze","mask-forge","banner-codex","render-matrix-pop"], canSend: ["design-eval"] },
