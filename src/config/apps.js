...
export const APP_REGISTRY = [
  ...
  { id: "prompt-builder",      label: "Prompt Builder",     sub: "Prompt Builder",      abbr: "Pb", icon: "◐", desc: "카드형 프롬프트 조립 — 모션·렌더링·타이포·배너 5 카테고리 + 커스텀 카드 + 프리셋",  group: "generate", color: "#A29BFE", canReceive: ["prompt-arc","render-metrics","motion-metrics","typecore-sovereign","typecore-breeze"], canSend: ["prompt-arc","motion-metrics","render-metrics","design-eval"], beta: true },
  { id: "prompt-builder-v2",   label: "프롬프트 빌더 v2",   sub: "Prompt Builder v2",   abbr: "P2", icon: "◑", desc: "CLI 패치 기반 카드형 프롬프트 빌더 — 모션·타이포 13장 카드 + 검증 + 프리셋",          group: "generate", color: "#FFD166", canReceive: [],                                                                              canSend: [], beta: true },
  ...
  { id: "mask-forge",          label: "Mask Forge",         sub: "Mask Forge",          abbr: "Mf", icon: "✂", desc: "Remove.bg AI로 이미지 배경을 4K 해상도까지 정밀 제거",   group: "production", color: "#FF3366", canReceive: [],                                                                              canSend: [] },
