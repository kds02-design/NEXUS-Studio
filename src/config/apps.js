...
export const APP_REGISTRY = [
  ...
  { id: "rubicon-forge",       label: "루비콘 포지",        sub: "Rubicon Forge",       abbr: "Rf", icon: "⬢", desc: "버튼 · 카드 · 패널 등 캠페인 컴포넌트 생성기",        group: "generate", color: "#55EFC4", canReceive: ["promotion-archive"],                                                          canSend: ["prompt-arc","design-eval"], disabled: true, adminOnly: true },
  ...
  { id: "mask-forge",          label: "Mask Forge",         sub: "Mask Forge",          abbr: "Mf", icon: "✂", desc: "Remove.bg AI로 이미지 배경을 4K 해상도까지 정밀 제거",   group: "production", color: "#FF3366", canReceive: ["typecore-breeze"],                                                       canSend: ["nexus-preview"] },
