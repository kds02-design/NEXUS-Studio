    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          border: `1px solid ${rejected ? "rgba(255,117,117,0.4)" : T.accent + "55"}`,
          display: "flex", alignItems: "center", justifyContent: "center",
          fontSize: 24, color: rejected ? "#ff7575" : T.accent,
        }}>
          {rejected ? "✕" : "⏳"}
        </div>

        <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.18em", color: rejected ? "#ff7575" : T.accent, textTransform: "uppercase", marginBottom: 8 }}>
